...
if ($method === 'POST') {
    ...
    if ($action === 'create') {
        ...
        if ($stmt->execute()) {
            ...
            $conn->query("INSERT INTO notifications (user_id, message, type) VALUES ($driver_id, '$msg', 'info')");
        ...
        if ($upd->execute()) {
            ...
            if ($action === 'accept') {
                ...
                $conn->query("INSERT INTO notifications (user_id, message, type) VALUES ($pass_id, '$msg', 'success')");
            }
